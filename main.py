...
# model
parser.add_argument('-save_dir',type=str,default='/home/hpcxu3/rds/hpc-work/summarunner_model/')
...
parser.add_argument('-train_dir',type=str,default='/home/hpcxu3/rds/hpc-work/summarunner_data/train.json')
parser.add_argument('-val_dir',type=str,default='/home/hpcxu3/rds/hpc-work/summarunner_data/val.json')
parser.add_argument('-embedding',type=str,default='/home/hpcxu3/rds/hpc-work/summarunner_data/embedding.npz')
parser.add_argument('-word2id',type=str,default='/home/hpcxu3/rds/hpc-work/summarunner_data/word2id.json')
parser.add_argument('-report_every',type=int,default=1500)
parser.add_argument('-seq_trunc',type=int,default=50)
parser.add_argument('-max_norm',type=float,default=1.0)
# test
parser.add_argument('-load_dir',type=str,default='/home/hpcxu3/rds/hpc-work/summarunner_model/RNN_RNN_seed_1.pt')
parser.add_argument('-test_dir',type=str,default='/home/hpcxu3/rds/hpc-work/summarunner_data/test.json')
parser.add_argument('-ref',type=str,default='/home/hpcxu3/SummaRuNNer/outputs/ref')
parser.add_argument('-hyp',type=str,default='/home/hpcxu3/SummaRuNNer/outputs/hyp')
...
def load_examples(f, label_algo, original_impl=False):
    """
        Convert json from .bert_json to the acceptable format for torch.utils.data.DataLoader.
    """
    if original_impl:
